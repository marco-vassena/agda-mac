...
εᶜ-Labeled-dist : ∀ {lᵈ τ} {c₁ c₂ : CTerm (Labeled lᵈ τ)} -> (lₐ : Label) (p : lᵈ ⊑ lₐ) -> 
                       c₁ ⟼ c₂ -> (εᶜ-Labeled lₐ p c₁) ⟼ (εᶜ-Labeled lₐ p c₂)
εᶜ-Labeled-dist lₐ p (AppL s) = AppL (εᶜ-dist lₐ s)
εᶜ-Labeled-dist {lᵈ} lₐ p Beta with lᵈ ⊑? lₐ
εᶜ-Labeled-dist lₐ p Beta | yes p' = Beta
εᶜ-Labeled-dist lₐ ¬p Beta | no p = ⊥-elim (p ¬p)
εᶜ-Labeled-dist {lᵈ} {c₁ = Γ , Var x} lₐ p Lookup with lᵈ ⊑? lₐ
εᶜ-Labeled-dist {lᵈ} {c₁ = Γ , Var x} lₐ p' Lookup | yes p rewrite εᶜ-Labeled-lookup p Γ x = Lookup
εᶜ-Labeled-dist {lᵈ} {c₁ = Γ , Var x} lₐ p Lookup | no ¬p = ⊥-elim (¬p p)
εᶜ-Labeled-dist {lᵈ} {c₁ = Γ , App f x} lₐ p Dist-$ rewrite εᶜ-Closure {t = x} lₐ = Dist-$
εᶜ-Labeled-dist lₐ p Dist-If = Dist-If
εᶜ-Labeled-dist lₐ p (IfCond s) = IfCond (εᶜ-dist lₐ s)
εᶜ-Labeled-dist {lᵈ} lₐ p IfTrue with lᵈ ⊑? lₐ
εᶜ-Labeled-dist lₐ p₁ IfTrue | yes p = IfTrue
εᶜ-Labeled-dist lₐ p IfTrue | no ¬p = ⊥-elim (¬p p)
εᶜ-Labeled-dist {lᵈ} lₐ p IfFalse with lᵈ ⊑? lₐ
εᶜ-Labeled-dist lₐ p₁ IfFalse | yes p = IfFalse
εᶜ-Labeled-dist lₐ p IfFalse | no ¬p = ⊥-elim (¬p p)
εᶜ-Labeled-dist lₐ p Dist-∙ = Dist-∙
εᶜ-Labeled-dist lₐ p Hole = Hole
...
εᶜ-Labeled-∙-dist {lᵈ} lₐ ¬p Beta with lᵈ ⊑? lₐ
εᶜ-Labeled-∙-dist lₐ ¬p Beta | yes p = Beta
εᶜ-Labeled-∙-dist lₐ ¬p₁ Beta | no ¬p = Beta
εᶜ-Labeled-∙-dist {lᵈ} {c₁ = Γ , Var x} lₐ ¬p Lookup with lᵈ ⊑? lₐ
εᶜ-Labeled-∙-dist {c₁ = Γ , Var x} lₐ ¬p Lookup | yes p = ⊥-elim (¬p p)
εᶜ-Labeled-∙-dist {c₁ = Γ , Var x} lₐ ¬p₁ Lookup | no ¬p rewrite εᶜ-Labeled-∙-lookup ¬p Γ x = Lookup
εᶜ-Labeled-∙-dist {c₁ = Γ , App f x} lₐ ¬p Dist-$ rewrite εᶜ-Closure {t = x} lₐ = Dist-$
εᶜ-Labeled-∙-dist lₐ ¬p Dist-If = Dist-If
εᶜ-Labeled-∙-dist lₐ ¬p (IfCond s) = IfCond (εᶜ-dist lₐ s)
εᶜ-Labeled-∙-dist {lᵈ} lₐ ¬p IfTrue with lᵈ ⊑? lₐ
εᶜ-Labeled-∙-dist lₐ ¬p IfTrue | yes p = ⊥-elim (¬p p)
εᶜ-Labeled-∙-dist lₐ ¬p₁ IfTrue | no ¬p = IfTrue
εᶜ-Labeled-∙-dist {lᵈ} lₐ ¬p IfFalse with lᵈ ⊑? lₐ
εᶜ-Labeled-∙-dist lₐ ¬p IfFalse | yes p = ⊥-elim (¬p p)
εᶜ-Labeled-∙-dist lₐ ¬p₁ IfFalse | no ¬p = IfFalse
εᶜ-Labeled-∙-dist lₐ ¬p Dist-∙ = Dist-∙
εᶜ-Labeled-∙-dist lₐ ¬p Hole = Hole
...
εᶜ-Mac-dist {c₁ = Γ , App f x} lₐ p  Dist-$ rewrite εᶜ-Closure {t = x} lₐ = Dist-$ 
...
εᶜ-Mac-dist {lᵈ} {τ} {c₁ = (Γ , Mac t) >>= k} lₐ p Bind rewrite εᶜ-Closure {t = t} lₐ = Bind
...
εᶜ-Mac-dist lₐ h⊑a (Dist-unlabel {l = lᵈ} {h = lʰ} d⊑h) | no ¬d⊑a = Dist-unlabel d⊑h -- Also absurd using transitivity
...
εᶜ-Mac-dist lₐ h⊑a (unlabelCtx d⊑h s) | yes d⊑a = unlabelCtx d⊑h (εᶜ-Labeled-dist lₐ d⊑a s)
...
εᶜ-dist {Bool} {c₁ = Γ , App f x} lₐ Dist-$ rewrite εᶜ-Closure {t = x} lₐ = Dist-$
...
εᶜ-dist {τ => τ₁} {c₁ = Γ , App f x} lₐ Dist-$ rewrite εᶜ-Closure {t = x} lₐ = Dist-$
...
εᶜ-dist {Labeled lᵈ τ} lₐ s | yes p = εᶜ-Labeled-dist lₐ p s
εᶜ-dist {Labeled lᵈ τ} lₐ s | no ¬p = εᶜ-Labeled-∙-dist lₐ ¬p s
...
εᶜ-dist {Exception} {c₁ = Γ , App f x} lₐ Dist-$ rewrite εᶜ-Closure {t = x} lₐ = Dist-$
