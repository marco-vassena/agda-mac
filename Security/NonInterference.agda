...
εᶜ-distributes-Closure {Mac l₂ τ} l₁ Γ t | no ¬p = refl -- This just does not hold
...
-- Inlining εᶜ-distributes-Closure
...
εᶜ-distributes-Labeled l₁ p (Dist-$ {α = Labeled x α}) = {!!}
...
εᶜ-distributes {Mac l₂ τ} {c₁} l₁ s | no ¬p = {!!} -- Inspecting s / c₁ / c₂ are not viable options
